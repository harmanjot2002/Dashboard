...
const TeacherCard = ({ img, subject, trainer, group, icon,lecture,all }) => {
    ...
    return (
        <div  className="w-80 relative flex py-10 gap-5 ps-5 pe-2 mt-1 items-center bg-slate-400 min-h-28 rounded-lg hover-effect">
            <div onClick={()=>{navigate("/teacher/"+all.id,{state:all})}} className="flex justify-center items-center">
            ...
            <div className="flex flex-col col-span-1 ">
                ...
                <div onClick={()=>{navigate("/teacher/"+all.id,{state:all})}} className="flex flex-col pt-0">
                    <Typography
                        variant="h5"
