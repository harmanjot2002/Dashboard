            ...
            <div className="flex flex-col justify-center items-center md:flex-row flex-1 gap-10">
                ...
                <div className="flex flex-col justify-center md:justify-start items-center md:items-start">
                    <div className="flex gap-2">
                        ...
                        <Typography variant={textVariant}>{teacher.name}</Typography>
                    </div>
                    <div className="flex gap-2">
                        <Typography variant={textVariant}>Age : </Typography>
                        <Typography variant={textVariant}>{teacher.age}</Typography>
                    </div>
                    <div className="flex gap-2">
                        <Typography variant={textVariant}>Groups : </Typography>
                        <Typography variant={textVariant}>{teacher.group}</Typography>
                    </div>
                    <div className="flex gap-2">
                        <Typography variant={textVariant}>Subject : </Typography>
                        <Typography variant={textVariant}>{teacher.subject}</Typography>
                    </div>
                    <div className="flex gap-2">
                        <Typography variant={textVariant}>Lecture : </Typography>
                        <Typography variant={textVariant}>{teacher.lecture}</Typography>
                    </div>
